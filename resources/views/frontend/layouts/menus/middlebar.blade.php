                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="{{Route('frontend.wishlist')}}"><span
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="{{Route('frontend.account')}}"><span class="lable
                                        ml-0">Account</span></a>
                                <div class="cart-dropdown-wrap cart-dropdown-hm2
                                    account-dropdown">
                                    <ul>
                                        <li>
                                            <a href="{{Route('frontend.account')}}"><i
                                                    class="fi fi-rs-user mr-10"></i>My
                                                Account</a>
                                        </li>
                                        <li>
                                            <a href="{{Route('frontend.account')}}"><i
                                                    class="fi fi-rs-location-alt
                                                    mr-10"></i>Order Tracking</a>
                                        </li>
                                        <li>
                                            <a href="{{Route('frontend.wishlist')}}"><i
                                                    class="fi fi-rs-heart
                                                    mr-10"></i>My Wishlist</a>
                                        </li>
                                        <li>
                                            <a href="{{Route('frontend.account')}}"><i
                                                    class="fi
