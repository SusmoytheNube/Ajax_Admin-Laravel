									...
									<div class="form-body">
										<form method="POST" action="{{ route('register') }}">
											...
											<div class="col-12">
												...
												<input type="email" class="form-control" id="email" name="email" required placeholder="example@user.com">
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												...
												<input type="password" class="form-control" id="password_confirmation" name="password_confirmation" required placeholder="Set Password">
											</div>
